...
@RestController
@RequestMapping("/om")
public class ShopController_Marshaling_ObjectMapper implements ShopControllerMarshaling {
    @Autowired
    ...
    public void add(HttpServletRequest request) {
        ...
        ShopDTO newShop = mapper.readValue(bodyString, ShopDTO.class);
        service.add(newShop);
    }
    ...
    public void getById(@PathVariable("id") Integer id, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (foundShop == null)
            ...
            try {
                ...
                response.getWriter().println(mapper.writeValueAsString(foundShop));
            } catch (IOException e) {
                response.setStatus(HttpStatus.INTERNAL_SERVER_ERROR.value());
            }
        }
    ...
    public void updateById(HttpServletRequest request, @PathVariable("id") Integer id, HttpServletResponse response) {
        ...
        try {
            ...
            shop = mapper.readValue(bodyString, ShopDTO.class);
        } catch (IOException e) {
        ...
        try {
            ...
            String bodyString = mapper.writeValueAsString(updatedShop);
